...
return [
    ...
    [
        'key'        => 'whatsapp',
        'name'       => 'admin::app.components.layouts.sidebar.whatsapp',
    ...
    [
        ...
        'name'       => 'admin::app.components.layouts.sidebar.whatsapp-templates',
        'route'      => 'admin.whatsapp.templates.index', // Cambiar esta línea
        'sort'       => 1,
        'icon'       => '',
    ],
    [
        'key'        => 'whatsapp.messages',
        'name'       => 'admin::app.components.layouts.sidebar.whatsapp-messages',
        'route'      => 'admin.whatsapp.messages.index', // Cambiar esta línea
        'sort'       => 2,
        'icon'       => '',
    ],
